...
## Следующие шаги
1. ~~Создать структуру проекта~~ (done)
2. ~~EDA в Jupyter Notebook~~ (done)
3. ~~Предобработка данных~~ (done)
4. ~~Выбрать и обосновать метрику~~ (done, F1-score)
5. ~~Обучить модель (F1 > 0.49)~~ (done, F1=0.48)
